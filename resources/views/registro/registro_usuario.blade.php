...
<body>
    <div class="container_formulario">
        <form action="/registro" method="POST" class="row g-8 mx-4 contenedor  mt-4 p-4 border rounded-4  d-flex justify-content-center aling-items-center" id="bgRegistro">
            @csrf
            ...
            <div class="col-12 d-flex justify-content-center mt-4" id="botoRegistro">
            <button class="btn btn-dark" type="submit" name="registrar" value="registrarse"></button>
            </div>
